...
const avatarLink = 'https://cdn.dribbble.com/users/1275/screenshots/2154492/media/7582ab673004df06fbac8dbef7211ad0.png',
	inviteLink = 'https://discord.com/api/oauth2/authorize?client_id=910123710638333983&permissions=274877974528&scope=bot';

export const helpEmbed = () => new MessageEmbed().
	setColor('#0099ff').
	setTitle('Bot Bò Sữa').
	setURL(inviteLink).
	setAuthor({ name: 'Bot Bò Sữa',
		iconURL: avatarLink,
		url: inviteLink }).
	...
	setTimestamp().
	setFooter('Bot được tạo ra bởi ThanhXuan', 'https://cdn.discordapp.com/avatars/526277128992325632/523f5d88ae0c0324c27c28d1fdef27d2.png?size=1024');
    

export const statsEmbed = (user,userRank,top)=> new MessageEmbed().
	setColor('#0099ff').
	...
	setDescription(top).
	setThumbnail(avatarLink).
	addField(`Thứ hạng của bạn: ${userRank} - ${user
		?user.totalMilk
		:0} lít sữa`,'Hãy tiếp tục vắt sữa nhé :"> ').
	setTimestamp().
